...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        if self.live_data and not self.bought:
            ...
            # make sure you use a price that is above the market price if you don't want to actually sell
            self.order = self.sell(size=1.0, exectype=Order.Limit, price=50.4326)
